...
let __wasmFilePath = __nodePath.join(__dirname, 'bb-calc-js.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'bb-calc-js.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  try {
    __wasmFilePath = require.resolve('bb-calc-js-wasm32-wasi/bb-calc-js.wasm32-wasi.wasm')
  } catch {
    throw new Error('Cannot find bb-calc-js.wasm32-wasi.wasm file, and bb-calc-js-wasm32-wasi package is not installed.')
  }
}
...
module.exports.gemFromInventory = __napiModule.exports.gemFromInventory
...
module.exports.parseGemEffects = __napiModule.exports.parseGemEffects
